        ...
        <div class="w-auto mx-auto sm:px-6 lg:px-8 overflow-x-auto">
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                ...
                <details class="bg-white shadow-sm rounded-lg my-5">
                    <summary class="cursor-pointer p-6 hover:opacity-25">Add Company</summary>
                    <div class="pb-2">
                        <form method="post" class="border rounded-lg p-4 mx-6 mb-6">
                            ...
                            <button type="submit" onclick="addCompany()" id="add-new-company" class="transition duration-300 ease-in-out rounded text-white bg-blue-800 hover:bg-blue-600 px-3 py-2">
                                Submit
                            </button>
                        </form>
                    </div>
                ...
                <div class="p-5 w-full">
                    ...
                    <x-datatable orderIndex="0" orderType="desc" id="company">
                        <x-slot name="headers">
                            <tr>
                            ...
                            <script>
                                $(document).ready(function () {
                                    var table = $('#company').DataTable({
                                        ...
                                        processing: true,
                                        serverSide: true,
                                        ajax: "{{ url('/company/datatable') }}?from={{ isset($query['from']) ? $query['from'] : null }}&to={{ isset($query['to']) ? $query['to'] : null }}",
                                        dom: 'Blfrtip',
                                        buttons: [
                                            {
                                                extend: 'excel',
                                        ...
                                        columns: [
                                            ...
                                            {data: 'username', name: 'phone_number'},
